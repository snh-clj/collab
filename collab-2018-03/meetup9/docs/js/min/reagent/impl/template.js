...
return cljs.core._write(writer__7150__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__13993 = o;
(G__13993[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__13994__delegate = function (args){
...
while (G__13995__i < G__13995__a.length) {G__13995__a[G__13995__i] = arguments[G__13995__i + 0]; ++G__13995__i;}
  args = new cljs.core.IndexedSeq(G__13995__a,0);
} 
...
var args = cljs.core.seq(arglist__13996);
...
if(cljs.core.truth_((function (){var and__6531__auto__ = cljs.core.some_QMARK_(jsprops);
...
var G__14001 = jsprops;
(G__14001["defaultValue"] = value);

(G__14001["onChange"] = ((function (G__14001,v,value,on_change){
return (function (p1__13999_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13999_SHARP_);
});})(G__14001,v,value,on_change))
);
...
var vec__14008 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14008,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14008,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14008,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___14013 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___14013 == null)){
} else {
var key_14014 = temp__4661__auto___14013;
(jsprops["key"] = key_14014);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__14016 = (new reagent.impl.template.NativeWrapper());
(G__14016["name"] = c);
...
var G__14018 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__14018) : reagent.impl.template.as_element.call(null,G__14018));
} else {
...
var len__7647__auto___14023 = arguments.length;
var i__7648__auto___14024 = (0);
while(true){
if((i__7648__auto___14024 < len__7647__auto___14023)){
args__7654__auto__.push((arguments[i__7648__auto___14024]));

var G__14025 = (i__7648__auto___14024 + (1));
i__7648__auto___14024 = G__14025;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7655__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq14021){
var G__14022 = cljs.core.first(seq14021);
var seq14021__$1 = cljs.core.next(seq14021);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__14022,seq14021__$1);
});
...
break;
default:
var G__14029 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__14029;
continue;
...
var n__7461__auto___14032 = a.length;
var i_14033 = (0);
while(true){
if((i_14033 < n__7461__auto___14032)){
(a[i_14033] = reagent.impl.template.as_element((a[i_14033])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7461__auto___14035 = a.length;
var i_14036 = (0);
while(true){
if((i_14036 < n__7461__auto___14035)){
var val_14037 = (a[i_14036]);
if((cljs.core.vector_QMARK_(val_14037)) && ((reagent.impl.template.key_from_vec(val_14037) == null))){
(o["no-key"] = true);
} else {
}

(a[i_14036] = reagent.impl.template.as_element(val_14037));

var G__14038 = (i_14036 + (1));
i_14036 = G__14038;
continue;
} else {
}
...
var ctx = ({});
var vec__14042 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14042,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14042,(1),null);
...
var G__14046 = (cljs.core.count(argv) - first_child);
switch (G__14046) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__14046){
